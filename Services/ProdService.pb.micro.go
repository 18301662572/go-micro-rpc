...
type ProdService interface {
	...
	//获取商品详情
	GetProdDeatil(ctx context.Context, in *ProdRequest, opts ...client.CallOption) (*ProdDeatilResponse, error)
}
...
func (c *prodService) GetProdDeatil(ctx context.Context, in *ProdRequest, opts ...client.CallOption) (*ProdDeatilResponse, error) {
	req := c.c.NewRequest(c.name, "ProdService.GetProdDeatil", in)
	out := new(ProdDeatilResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
type ProdServiceHandler interface {
	...
	//获取商品详情
	GetProdDeatil(context.Context, *ProdRequest, *ProdDeatilResponse) error
}
...
func RegisterProdServiceHandler(s server.Server, hdlr ProdServiceHandler, opts ...server.HandlerOption) error {
	type prodService interface {
		...
		GetProdDeatil(ctx context.Context, in *ProdRequest, out *ProdDeatilResponse) error
	}
	type ProdService struct {
		prodService
	}
...
func (h *prodServiceHandler) GetProdDeatil(ctx context.Context, in *ProdRequest, out *ProdDeatilResponse) error {
	return h.ProdServiceHandler.GetProdDeatil(ctx, in, out)
}
